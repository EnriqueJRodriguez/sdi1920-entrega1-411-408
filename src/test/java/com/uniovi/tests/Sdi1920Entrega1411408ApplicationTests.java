...
//				Assert.isTrue(!userService.getUserByEmail(repeatedEmail).getLastName().equals("Monzon"), "El usuario repetido no se inserto" );
	...
	public void PR09() {
		...
		PO_NavView.checkNoElement(driver, "users.title", PO_Properties.getSPANISH());
	}
	...
	public void PR11() {
		...
		PO_PrivateView.checkElement(driver, "text", "max@arcadia.com");
		PO_PrivateView.checkElement(driver, "text", "pepitosdi@uniovi.es");
		PO_PrivateView.checkElement(driver, "text", "laurapalmer@twinpeaks.com");
		// Comprobamos que no sale el administrador
		PO_PrivateView.checkNoElement(driver, "juansdi@uniovi.es");
		// Comprobamos que no sale el propio usuario logueado
		PO_PrivateView.checkNoElement(driver, "jaimitosdi@uniovi.es");
	...
	public void PR13() {
		...
		PO_PrivateView.checkNoElement(driver, "max@arcadia.com");
		PO_PrivateView.checkNoElement(driver, "pepitosdi@uniovi.es");
		PO_PrivateView.checkNoElement(driver, "laurapalmer@twinpeaks.com");
		PO_PrivateView.checkNoElement(driver, "juansdi@uniovi.es");
		PO_PrivateView.checkNoElement(driver, "jaimitosdi@uniovi.es");
		// Nos desconectamos
		PO_PrivateView.logout(driver);
	...
	public void PR14() {
		...
		PO_PrivateView.checkElement(driver, "text", "1");
	...
	public void PR15() {
		...
		List<WebElement> botones = PO_PrivateView.checkElement(driver, "free",
		...
		List<WebElement> elementos = PO_PrivateView.checkElement(driver, "free", "//li[contains(@id, 'invitations-menu')]/a");
		elementos.get(0).click();
		// Pinchamos en la opción de lista de invitaciones.
		elementos = PO_PrivateView.checkElement(driver, "free", "//a[contains(@href, '/invitation/list')]");
		elementos.get(0).click();
	...
	public void PR17() {
		...
		elementos = PO_PrivateView.checkElement(driver, "free", "//td/div");
	...
	public void PR19() {
		...
		List<WebElement> elementos = PO_PrivateView.checkElement(driver, "free", "//li[contains(@id, 'friends-menu')]/a");
		elementos.get(0).click();
		// Pinchamos en la opción de lista de amigos.
		elementos = PO_PrivateView.checkElement(driver, "free", "//a[contains(@href, '/friend/list')]");
		elementos.get(0).click();
		// Miramos que tenemos un amigo
		elementos = PO_PrivateView.checkElement(driver, "free", "//td[contains(text(), 'jaimitosdi@uniovi.es')]");
		assertEquals(1, elementos.size());
		// Nos desconectamos
		PO_PrivateView.logout(driver);
	}
	...
	public void PR24() {
		...
		driver.get(URL+"/publication/list");
		// Comprobamos que entramos en la pagina publicaciones
		PO_PrivateView.checkKey(driver,"publications.title", PO_Properties.getSPANISH());
	...
	public void PR31() {
		...
		PO_PrivateView.checkElement(driver, "text", "pepitosdi@uniovi.es");
		PO_PrivateView.checkElement(driver, "text", "laurapalmer@twinpeaks.com");
		PO_PrivateView.checkElement(driver, "text", "jaimitosdi@uniovi.es");
		// Comprobamos que sale el otro administrador
		PO_PrivateView.checkElement(driver, "text", "juansdi@uniovi.es");
		// Comprobamos que no sale el propio usuario logueado
		PO_PrivateView.checkNoElement(driver, "legoshi@beastars.es");
		// Nos desconectamos
		PO_PrivateView.logout(driver);
	}
	...
	private void pr20checks(int language) {
		...
		// Pinchamos en la opción de menú de amigos
		elementos = PO_PrivateView.checkElement(driver, "free", "//li[contains(@id, 'friends-menu')]/a");
		elementos.get(0).click();
		// Pinchamos en la opción de lista de amigos.
		elementos = PO_PrivateView.checkElement(driver, "free", "//a[contains(@href, '/friend/list')]");
		elementos.get(0).click();
		// Miramos que estamos en la vista de amigos
		PO_PrivateView.checkKey(driver, "friends.title", language);

		// Pinchamos en la opción de menu de invitaciones
		elementos = PO_PrivateView.checkElement(driver, "free", "//li[contains(@id, 'invitations-menu')]/a");
		elementos.get(0).click();
		// Pinchamos en la opción de lista de amigos.
		elementos = PO_PrivateView.checkElement(driver, "free", "//a[contains(@href, '/invitation/list')]");
		elementos.get(0).click();
		// Miramos que estamos en la vista de amigos
		PO_PrivateView.checkKey(driver, "invitations.title", language);
